...
public class HttpConnection {
    public static JSONArray getJsonArray(String baseDate, String lat, String lot, String baseTime) {
        ...
        try {
            ...
            URL url = new URL("http://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getVilageFcst?base_time="+baseTime+"&nx="+lat+"&serviceKey=해킹어림없지&numOfRows=900&pageNo=1&base_date="+ baseDate +"&ny="+lot+"&dataType=JSON");
